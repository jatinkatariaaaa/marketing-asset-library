    ...
    <main className="mx-auto min-h-screen w-full max-w-6xl px-4 py-10 md:px-8 md:py-14">
      <header className="mb-10 flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
          {assets.length} production-ready creatives — clean light-theme
          Instagram posts plus the marble luxury poster set. Filter by category
          and download any asset as a PNG. Files live in{' '}
